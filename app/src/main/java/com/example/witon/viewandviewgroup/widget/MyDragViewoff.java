 ...
 */
public class MyDragViewoff extends View {
    ...
    public MyDragViewoff(Context context) {
        this(context,null);
    }

    public MyDragViewoff(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public MyDragViewoff(Context context, AttributeSet attrs, int defStyleAttr) {
